 ...
 */
public class NovaDespesaPessoal extends javax.swing.JPanel {

    /**
     * Creates new form NovaDespesaPessoal
     */
    public NovaDespesaPessoal() {
        initComponents();
    ...
    private void cadastrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cadastrarActionPerformed
        ...
        if (this.descricao.getText().equals("") || this.valor.getText().equals("") || this.dataEmissao.getText().equals("")) {
            JOptionPane.showMessageDialog(null, "Complete todos os campos", "Atenção", JOptionPane.WARNING_MESSAGE);
        } else {
            DespesaPessoal despesa = new DespesaPessoal();
            ...
            GenericoDAO<DespesaPessoal> genericoDes = new GenericoDAO<DespesaPessoal>(DespesaPessoal.class, sessao);
